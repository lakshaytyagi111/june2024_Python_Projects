...
def usage():
    ...
    print()
    print("Examples: ")
    print("replacing_netcat.py -t 192.168.0.1 -p 5555 -l -c")
    print("replacing_netcat.py -t 192.168.0.2 -p 5555 -l -u=c:\\target.exe")
    print("replacing_netcat.py -t 192.168.0.3 -p 5555 -l -e=\"cat /etc/passwd\"")
    print("echo 'ABCDEFGHI' | ./replacing_netcat.py -t 192.168.0.4 -p 135")
    sys.exit(0)
